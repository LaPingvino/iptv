...
CREATOR_CIRCLES = {
    ...
    "ryukahr": ["tammy_blackmedia", "dgr_dave", "smallant", "thabeast721", "aurateur", "grandpoobear"],
    "tammy_blackmedia": ["ryukahr", "elanaorama", "smallant", "dgr_dave"],
    ...
    "elanaorama": ["smallant", "tammy_blackmedia", "ryukahr", "speedrun"],
